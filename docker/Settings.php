...
$boardurl = 'http://localhost:8080';		# URL to your forum's folder. (without the trailing /!)
$webmaster_email = 'a@a.com';		# Email address to send emails from. (like noreply@yourdomain.com.)
...
$image_proxy_secret = 'bea85b945518b1689c44';
